...
import { signupRider } from "@/redux/slices/rider/authSlice";
...
//   };
  ...
  const handleSubmit = async () => {
    ...
    const res = await dispatch(signupRider(formData));
    if (res.meta.requestStatus === "fulfilled") {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.form}>
        {/* FIRST NAME */}
        <AppText variant="small" style={styles.label}>Name</AppText>
        <TextInput
          style={styles.input}
          value={formData.name}
        ...
        {/* LOGIN LINK */}
        <TouchableOpacity onPress={() => router.push("/rider-login")}>
